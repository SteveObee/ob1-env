...
while IFS=" ," read src ev1 ev2 ch label1 data1 label2 data2 rest; do
    case "$ev1 $ev2 $data1 $data2" in
        "Control change 46 127" ) xdotool key Super_L+Shift+semicolon ;;
        "Control change 58 127" ) xdotool key Super_L+Shift_L+q ;;
        "Control change 59 127" ) xdotool key Super_L+q ;;
        "Control change 61 127" ) xdotool key Super_L+semicolon ;;
        ...
        "Control change 45 127" ) xdotool search "Navigator" key F5 ; xdotool search "VLC media player" key F5 ;;
	...
	"Control change 60 127" ) xdotool search "Navigator" key Control_L+w;;
	"Control change 62 127" ) xdotool search "Navigator" key Control_L+Page_Down;;
        ...
        "Control change 39 127" ) systemctl suspend ;;
        "Control change 55 127" ) poweroff ;;
        "Control change 70 127" ) killall i3bar; i3bar --bar_id=bar-1 ;;       
        "Control change 71 127" ) reboot ;;
    esac
done
