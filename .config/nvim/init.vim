...
" === vim-php-cs-fixer === "
let g:php_cs_fixer_path = "~/.composer/vendor/friendsofphp/php-cs-fixer/php-cs-fixer" " define the path to the php-cs-fixer.phar
...
nnoremap <leader>jw :<C-u>DeniteCursorWord grep:.<CR>
